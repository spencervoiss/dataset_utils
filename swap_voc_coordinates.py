...
parser = argparse.ArgumentParser(
    description="Script for swapping the x and y coordinates of all bounding boxes in a Pascal VOC xml formatted dataset file"
)
parser.add_argument(
    "--input", "-i", type=str, required=True, help="Path to the dataset file to be swapped"
)
parser.add_argument(
